...
public sealed class Lead
{
    ...
    public string? ModeloInteresTexto
    {
        get; private set;
    }
    public LeadStatus EstadoGestion
    {
        get; private set;
    }
    public DateTime? FechaPrimerContacto
    {
        get; private set;
    }
    ...
    public string? CiudadNormalizada
    {
        get; private set;
    }
    public string? CanalNormalizado
    {
        get; private set;
    }
    public string? ModeloTextoNormalizado
    {
        get; private set;
    }
    public string? MotorcycleSku
    {
        get; private set;
    }
    public decimal? ModelMatchConfidence
    {
        get; private set;
    }
    public string? ModelMatchMethod
    {
        get; private set;
    }
    private Lead()
