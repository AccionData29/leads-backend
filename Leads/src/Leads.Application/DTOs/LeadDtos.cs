...
public sealed record PipelineRunDto(Guid RunId, string Status, DateTime StartedAt, DateTime? FinishedAt, int RecordsRead, int RecordsProcessed, int RecordsFailed, string? SummaryJson, string? Error);
